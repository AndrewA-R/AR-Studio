...
export default function CaseStrategy({n = '03', kicker = 'Strategy', title, body, positioning, framework, dark = false}) {
    ...
    <section style={{background: bg, color: fg, padding: '88px clamp(24px,4vw,56px)'}}>
      <div style={{maxWidth: 1440, margin: '0 auto'}}>
        ...
        <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'start'}}>
          <div>
            <p style={{fontFamily: '"Newsreader", Georgia, serif', fontSize: 19, lineHeight: 1.65, color: fg, margin: 0, maxWidth: '44ch'}}>{body}</p>
            {positioning && (
