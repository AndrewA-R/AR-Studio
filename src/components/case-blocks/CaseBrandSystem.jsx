    ...
    <section className="py-24 md:py-[88px] px-6 md:px-[clamp(24px,4vw,56px)]" style={{background: AR_PAPER}}>
      <div style={{maxWidth: 1440, margin: '0 auto'}}>
        ...
        <div className="brand-system-grid mt-6" style={{display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: 16}}>
          ...
          <div className="bs-cell" style={{gridColumn: 'span 4', aspectRatio: '4/3', background: AR_WHITE, border: '1px solid rgba(17,16,16,0.14)', position: 'relative', overflow: 'hidden'}}>
            {logoSrc
          ...
          {typography && (
            <div className="bs-cell" style={{gridColumn: 'span 4', aspectRatio: '4/3', background: AR_WHITE, border: '1px solid rgba(17,16,16,0.14)', padding: 24, display: 'flex', flexDirection: 'column', justifyContent: 'space-between'}}>
              <div>
          ...
          {tmpls.map((t, i) => {
            ...
            return (
              <div key={i} className="bs-cell" style={{gridColumn: 'span 4', aspectRatio: '4/5', border: '1px solid rgba(17,16,16,0.14)', position: 'relative', overflow: 'hidden', background: AR_WHITE}}>
                {videoSrc
