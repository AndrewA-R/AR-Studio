    ...
    <PageShell>
      <section className="bg-paper border-b border-ink/10 px-[clamp(24px,4vw,56px)] pt-20 pb-16">
        <div className="max-w-wide mx-auto grid grid-cols-1 lg:grid-cols-[1.4fr_1fr] gap-y-10 gap-x-16 items-start">
          <div>
            <div className="font-mono text-[11px] tracking-[0.22em] uppercase text-purple-700 mb-7" style={{ whiteSpace: "pre-line" }}>{kicker}</div>
            <h1
            ...
            <p
              className="mt-9 max-w-[60ch] text-ink-600"
              style={{ fontFamily: '"Newsreader", Georgia, serif', fontSize: 21, lineHeight: 1.55, whiteSpace: "pre-line" }}
            >
              {lede}
            </p>
          </div>
